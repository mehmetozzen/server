...
interface PermissionName extends BaseEnum
{
	...
	const FEATURE_KALTURA_LIVE_DELETE_RECORDED_VOD = 'FEATURE_KALTURA_LIVE_DELETE_RECORDED_VOD';
	...
	const FEATURE_DISABLE_PASSWORD_RESTRICTION = 'FEATURE_DISABLE_PASSWORD_RESTRICTION';
	...
	const FEATURE_DISABLE_STATIC_CONTENT_CONVERSION = 'FEATURE_DISABLE_STATIC_CONTENT_CONVERSION';
	const FEATURE_KALTURA_LIVE_SYNC_RECORDED_VOD_CATEGORY = 'FEATURE_KALTURA_LIVE_SYNC_RECORDED_VOD_CATEGORY';
	const FEATURE_BLOCK_MEETING_ROOMS = 'FEATURE_BLOCK_MEETING_ROOMS';
	...
	const FEATURE_RESTRICT_ACCESS_CONTROL_ALLOW_ORIGIN_DOMAINS = 'FEATURE_RESTRICT_ACCESS_CONTROL_ALLOW_ORIGIN_DOMAINS';
	...
	const FEATURE_LOAD_THUMBNAIL_WITH_KS = 'FEATURE_LOAD_THUMBNAIL_WITH_KS';
	...
	const FEATURE_PURGE_USER_PII_DATA = 'FEATURE_PURGE_USER_PII_DATA';
	...
	const FEATURE_V7_STUDIO_PERMISSION = 'FEATURE_V7_STUDIO_PERMISSION';
	...
	const GAME_PLUGIN_PERMISSION = 'GAME_PLUGIN_PERMISSION';
	const FEATURE_MEDIA_REPURPOSING_NG_PERMISSION = 'FEATURE_MEDIA_REPURPOSING_NG_PERMISSION';
	const FEATURE_ALLOW_CNC_PERMISSION = 'FEATURE_ALLOW_CNC_PERMISSION';
	const FEATURE_RECYCLE_BIN = 'FEATURE_RECYCLE_BIN';
	const SCHEDULEDTASK_PLUGIN_PERMISSION = 'SCHEDULEDTASK_PLUGIN_PERMISSION';
	const SSO_ADMIN_PERMISSION = 'SSO_ADMIN_PERMISSION';
	const ALLOW_SSO_PER_USER = 'ALLOW_SSO_PER_USER';
	const FEATURE_THEME_EDITOR_PERMISSION = 'FEATURE_THEME_EDITOR_PERMISSION';
	const FEATURE_EVENT_PLATFORM_PERMISSION = 'FEATURE_EVENT_PLATFORM_PERMISSION';
	const FEATURE_EP_AI_PERMISSION = 'FEATURE_EP_AI_PERMISSION';
	const FEATURE_ENABLE_INTERACTIONS_PERMISSION = 'FEATURE_ENABLE_INTERACTIONS_PERMISSION';
	...
	const RATING_LIST_ADMIN = 'RATING_LIST_ADMIN';
	...
	const FEATURE_LIMIT_ALLOWED_ACTIONS = 'FEATURE_LIMIT_ALLOWED_ACTIONS';
	...
	const FEATURE_MULTI_ACCOUNT_ANALYTICS = 'FEATURE_MULTI_ACCOUNT_ANALYTICS';

	const FEATURE_LIVE_ENTRIES_IN_FEED = 'FEATURE_LIVE_ENTRIES_IN_FEED';

	const FEATURE_DISABLE_PREVIEW_PAGE = 'FEATURE_DISABLE_PREVIEW_PAGE';

	const FEATURE_SYNC_VOD_LIVE_METADATA = 'FEATURE_SYNC_VOD_LIVE_METADATA';
	const FEATURE_CONTENT_LAB = 'FEATURE_CONTENT_LAB';
	const FEATURE_CONTENT_LAB_DISPLAY_ALL_FEATURES = 'FEATURE_CONTENT_LAB_DISPLAY_ALL_FEATURES';
	const FEATURE_V2_V7_REDIRECT = 'FEATURE_V2_V7_REDIRECT';

	const FEATURE_EMBED_SHARE_SOCIAL_STREAM = 'FEATURE_EMBED_SHARE_SOCIAL_STREAM';

	const FEATURE_DISABLE_NO_CATEGORY_ENTRY_ENTITLEMENT_CHECK = "FEATURE_DISABLE_NO_CATEGORY_ENTRY_ENTITLEMENT_CHECK";

	const FEATURE_DISABLE_NEW_ICAL_STANDARD = 'FEATURE_DISABLE_NEW_ICAL_STANDARD';
	const FEATURE_DISABLE_FLAVORS_OPTIMIZATION = 'FEATURE_DISABLE_FLAVORS_OPTIMIZATION';
	const FEATURE_ENABLE_FOLDERS_CAPABILITIES = 'FEATURE_ENABLE_FOLDERS_CAPABILITIES';

	const FEATURE_ALLOW_IMMERSIVE_AGENTS = 'FEATURE_ALLOW_IMMERSIVE_AGENTS';
}
